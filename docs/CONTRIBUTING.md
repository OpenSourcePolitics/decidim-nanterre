  # How to contribute to Nanterre

We're really glad you're reading this, you might be interested by the code source of the Nanterre decidim application.
...
* If you're unable to find an open issue addressing the problem, [open a new one on the current repository](https://github.com/OpenSourcePolitics/decidim-nanterre). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
